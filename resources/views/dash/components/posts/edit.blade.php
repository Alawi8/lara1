                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="lastName" name="slug" placeholder="" value="{{ $editing->slug }}">
                                    <div class="invalid-feedback">
                                        حقل الوصف مطلوب
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="category" name="category_id">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ $category->id == $editing->category_id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('img_url') is-invalid @enderror"
                                        id="lastName" name="img_url" placeholder="" value="{{ $editing->img_url }}">
                                    <div class="invalid-feedback">
                                        حقل الوصف مطلوب
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <label for="lastName" class="form-label">الكلمات المفتاحيه</label>
                                ...
                                <button class="w-100 btn btn-primary btn-lg" type="submit">أكمال التعديل
                                </button>
                        </form>
                    </div>
                </div>

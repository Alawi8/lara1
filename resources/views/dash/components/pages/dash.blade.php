...
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <div class="card z-index-2 ">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                    <div class="bg-light-primary shadow-dark border-radius-lg py-3 pe-1">
                        <div class="chart">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <div class="card z-index-2  ">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                    <div class="bg-light-success shadow-dark border-radius-lg py-3 pe-1">
                        <div class="chart">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('material/img/small-logos/logo-xd.svg') }}"
                                    ...
                                    <td>
                                        <div class="avatar-group mt-2">
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                ...
                                                <img alt="Image placeholder" src="{{ asset('material/img/team-1.jpg') }}">
                                            </a>
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                                <img alt="Image placeholder" src="{{ asset('material/img/team-2.jpg') }}">
                                            </a>
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title="Alexander Smith">
                                                <img alt="Image placeholder" src="{{ asset('material/img/team-3.jpg') }}">
                                            </a>
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                                <img alt="Image placeholder" src="{{ asset('material/img/team-4.jpg') }}">
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('material/img/small-logos/logo-atlassian.svg') }}"
                                                    class="avatar avatar-sm ms-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('material/img/small-logos/logo-slack.svg') }}"
                                                    class="avatar avatar-sm ms-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <div class="avatar-group mt-2">
                                            ...
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                ...
                                                <img alt="Image placeholder"
                                                    src="{{ asset('material/img/team-1.jpg') }}">
                                            </a>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                    ...
                                    <td>
                                        <div class="avatar-group mt-2">
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                                                <img alt="Image placeholder"
                                                    src="{{ asset('material/img/team-4.jpg') }}">
                                            </a>
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                                <img alt="Image placeholder"
                                                    src="{{ asset('material/img/team-3.jpg') }}">
                                            </a>
                                            <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title="Alexander Smith">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('material/img/small-logos/logo-jira.svg') }}"
                                                    class="avatar avatar-sm ms-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img src="{{ asset('material/img/small-logos/logo-invision.svg') }}"
                                                    class="avatar avatar-sm ms-3">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
